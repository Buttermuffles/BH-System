                        ...
                        <div className="lg:col-span-3 space-y-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <button onClick={addRoom} className="text-sm text-blue-600 hover:text-blue-800 font-medium inline-flex items-center gap-2">Add Room</button>
                                </div>
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-100">
                                            {rooms.map((room) => (
                                                <tr key={room.id}>
                                                    ...
                                                    <td className="px-3 py-2">
                                                        <button onClick={() => removeRoom(room.id)} className="text-red-600 hover:text-red-800 inline-flex items-center p-1 rounded hover:bg-red-50">Remove</button>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
                                ...
                                <div className="mt-6 flex space-x-3">
                                    <button onClick={calculateBills} className="flex-1 bg-gradient-to-r from-blue-600 to-blue-500 text-white py-2 px-4 rounded-lg">Calculate All</button>
                                    <button onClick={resetForm} className="px-6 py-2 border border-gray-200 text-gray-700 rounded-lg">Reset</button>
                                </div>
                                </div>
                                <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 mt-6">
                                    ...
                                    {calculatedBills.length > 0 ? (
                                        <div className="space-y-4">
                                            ...
                                            <button onClick={printReceipt} className="w-full bg-green-600 text-white py-2 px-4 rounded-lg">Print Receipts</button>
